...
<>
    ...
    <main className="mx-auto my-auto">
        <div className="w-[390px] h-[844px] relative bg-neutral-700"
            ...
            <div
                className="w-[368px] pt-[90px] left-[11px]  absolute flex-col justify-center items-center gap-3 inline-flex">
                <div className="w-[368px] h-[232.25px] relative">
                    <div
                        className="w-[274px] h-[70px]  top-0 absolute justify-center items-center gap-[13px] inline-flex">
                        <img className="w-[70px] h-[70px] rounded-[26px]" src={"images/perfil.png"} />
                        <div className="flex-col justify-center items-start inline-flex">
                            <div className="text-white text-base font-bold font-['Be Vietnam'] uppercase">Hannah Smith
                            </div>
                            <div className="text-white text-xs font-normal font-['Be Vietnam'] leading-[18px]">
                                @hannah_super</div>
                            <div className="text-white text-xs font-normal font-['Be Vietnam'] leading-[18px]">Ontem
                            </div>
                        </div>
                    </div>
                    <div className="w-[368px] h-[156.05px] left-0 top-[76.20px] absolute">
                        <div
                            className="h-[132px] py-[22px] left-0 top-[23.80px] absolute bg-white rounded-[26px] flex-col justify-center items-center gap-2.5 inline-flex">
                            <div
                                className="w-[283px] pl-[10px] text-zinc-800 text-xs font-normal font-['Be Vietnam'] leading-[18px]">
                                Hoje fiz uma viagem incrível para as bahamas. É incrível o quão fácil é viajar quando se
                                acumula milhas</div>
                            <div className="self-stretch pr-3.5 justify-end items-center gap-2.5 inline-flex">
